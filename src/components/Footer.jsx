            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="flex flex-col md:flex-row md:justify-between">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 text-center md:text-left">
                        <a href="#" className="hover:underline text-gray-500 dark:text-gray-400 font-medium">Contacto</a>
                        <a href="#" className="hover:underline text-gray-500 dark:text-gray-400 font-medium">Seguinos</a>
                        <a href="#" className="hover:underline text-gray-500 dark:text-gray-400 font-medium">About Us</a>
                    </div>
                </div>
